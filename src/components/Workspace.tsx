    ...
    <main className="workspace">
      ...
      <aside className={`sidebar ${mobileMenu ? 'open' : ''}`}>
        ...
        <div className="workspace-switcher">
          ...
          <span><strong>{profile?.organization?.name || 'Sysmobyte HQ'}</strong><small>{profile?.organization?.subdomain ? `${profile.organization.subdomain}.sysmobyte.app` : 'Personal workspace'}</small></span>
          <ChevronDown size={15} />
        </div>
