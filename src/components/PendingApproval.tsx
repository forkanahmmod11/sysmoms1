...
export function PendingApproval({ onLogout, onApproved }: { onLogout: () => void; onApproved: () => Promise<void> | void }) {
            ...
            <>
              ...
              <p>
                {request?.status === 'rejected'
                  ...
                  : 'Subscription request submitted. You will be notified soon. Your Request is Under Review, and your isolated workspace will be activated automatically once the admin approves the payment.'}
              </p>
              ...
              {request && (
                <div className="pending-details">
                  ...
                  <div className="pending-detail-row">
                    ...
                    <strong>{request.payment_method ? request.payment_method.toUpperCase() : "Not recorded"}</strong>
                  </div>
                  <div className="pending-detail-row">
                    <span>Transaction ID / reference</span>
                    <strong>{request.payment_reference || "Not recorded"}</strong>
                  </div>
                  <div className="pending-detail-row">
